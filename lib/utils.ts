...
export function createActionsSchemas<AP extends Record<string, Action<any, any>>>(actions: AP) {
...
// biome-ignore lint/suspicious/noExplicitAny: <explanation>
export function createActionsActions<AP extends Record<string, Action<any, any>>>(actions: AP) {
	type ActionName = keyof AP
